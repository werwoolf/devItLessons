...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.scss */ \"./src/style.scss\");\n/* harmony import */ var _scripts_Game_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./scripts/Game.mjs */ \"./src/scripts/Game.mjs\");\n/* harmony import */ var _scripts_helpers_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./scripts/helpers.mjs */ \"./src/scripts/helpers.mjs\");\n\n\n\nvar startGameButton = document.querySelector('.startGameButton');\nvar takeCardButton = document.querySelector('.takeCardButton');\nvar stopGameButton = document.querySelector('.stopGameButton');\nvar cardsCount = document.querySelector('.cardsCount');\nvar containerButton = document.querySelector('.buttonContainer');\nvar startGameContainer = document.querySelector('.startGameContainer');\nvar playersTables = document.querySelectorAll('.playerTable');\nvar placeStoreCards = document.querySelectorAll(\".placeStoreCards\");\nvar playersRatings = document.querySelectorAll('.playerRaiting');\nvar placesPlayerNames = document.querySelectorAll(\".playerName\");\nvar game = null;\nstartGameButton.addEventListener('click', function () {\n  game = startGame();\n  (0,_scripts_helpers_mjs__WEBPACK_IMPORTED_MODULE_2__.writeMessage)(\"now step \".concat(game.activePlayer.name));\n  actuallyVisual(game);\n});\ntakeCardButton.addEventListener('click', function () {\n  if (!game.activePlayer || game.activePlayer.rating > 20) {\n    actuallyVisual(game);\n    return (0,_scripts_helpers_mjs__WEBPACK_IMPORTED_MODULE_2__.writeMessage)(game.passPlayer());\n  }\n\n  game.activePlayer.getCard(game.cards.pop());\n\n  if (!game.activePlayer || game.activePlayer.rating > 20) {\n    actuallyVisual(game);\n    return (0,_scripts_helpers_mjs__WEBPACK_IMPORTED_MODULE_2__.writeMessage)(game.passPlayer());\n  }\n\n  actuallyVisual(game);\n});\nstopGameButton.addEventListener('click', function () {\n  (0,_scripts_helpers_mjs__WEBPACK_IMPORTED_MODULE_2__.writeMessage)(game.passPlayer());\n  actuallyVisual(game);\n});\n\nfunction startGame() {\n  var playerN1 = document.querySelector('.inputPlayer.n1');\n  var playerN2 = document.querySelector('.inputPlayer.n2');\n  var playerN3 = document.querySelector('.inputPlayer.n3');\n  var playerN4 = document.querySelector('.inputPlayer.n4');\n  var players = [playerN1.value, playerN2.value, playerN3.value, playerN4.value].filter(function (player) {\n    return player;\n  });\n  return new _scripts_Game_mjs__WEBPACK_IMPORTED_MODULE_1__[\"default\"](players);\n}\n\nfunction actuallyVisual(game) {\n  if (game.activeGame) {\n    containerButton.style.display = 'flex';\n    startGameContainer.style.display = 'none';\n  } else {\n    containerButton.style.display = 'none';\n    startGameContainer.style.display = 'block';\n  }\n\n  game.players.forEach(function (player, index) {\n    playersTables[index].style.display = 'inline-block';\n    placeStoreCards[index].innerHTML = '';\n    player.cards.forEach(function (card) {\n      return placeStoreCards[index].appendChild((0,_scripts_helpers_mjs__WEBPACK_IMPORTED_MODULE_2__.visualCreateCard)(card));\n    });\n    playersRatings[index].innerHTML = player.rating;\n    placesPlayerNames[index].innerHTML = player.name;\n  });\n  cardsCount.innerHTML = game.cards.length;\n}\n\n//# sourceURL=webpack://blackdjack/./src/index.mjs?");

/***/ }),

/***/ "./src/scripts/Card.mjs":
/*!******************************!*\
  !*** ./src/scripts/Card.mjs ***!
  \******************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ Card)\n/* harmony export */ });\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar Card = function Card(_ref) {\n  var suit = _ref.suit,\n      rating = _ref.rating,\n      name = _ref.name;\n\n  _classCallCheck(this, Card);\n\n  this.suit = suit;\n  this.rating = rating;\n  this.name = name;\n};\n\n\n\n//# sourceURL=webpack://blackdjack/./src/scripts/Card.mjs?");

/***/ }),

/***/ "./src/scripts/Game.mjs":
/*!******************************!*\
  !*** ./src/scripts/Game.mjs ***!
  \******************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ Game)\n/* harmony export */ });\n/* harmony import */ var _Card_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Card.mjs */ \"./src/scripts/Card.mjs\");\n/* harmony import */ var _Player_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Player.mjs */ \"./src/scripts/Player.mjs\");\n/* harmony import */ var _helpers_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./helpers.mjs */ \"./src/scripts/helpers.mjs\");\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\n\n\n\nvar listCards = [2, 3, 4, 5, 6, 7, 8, 9, 10, 'Jack', 'Lady', 'King', 'Ace'];\nvar listSuits = ['club', 'diamond', 'heart', 'spade'];\n\nvar Game = /*#__PURE__*/function () {\n  function Game(players) {\n    _classCallCheck(this, Game);\n\n    this.activeGame = true;\n    this.cards = this.cardGenerate();\n    this.players = this.playersGenerate(players);\n    this.firstDealCards();\n    this.canStep = this.players.filter(function (player) {\n      return player.rating < 21;\n    });\n\n    if (this.players.length === 0) {\n      throw new Error('need min 1 player');\n    }\n\n    this.activePlayer = (0,_helpers_mjs__WEBPACK_IMPORTED_MODULE_2__.findMaxRaitingPlayers)(this.canStep)[0];\n  }\n\n  _createClass(Game, [{\n    key: \"cardGenerate\",\n    value: function cardGenerate() {\n      var cards = [];\n\n      for (var i = 0; i < listCards.length; i++) {\n        var rating = null;\n        typeof listCards[i] === 'number' ? rating = listCards[i] : rating = 10;\n\n        if (listCards[i] === 'Ace') {\n          rating = 11;\n        }\n\n        cards.push(new _Card_mjs__WEBPACK_IMPORTED_MODULE_0__[\"default\"]({\n          suit: listSuits[0],\n          rating: rating,\n          name: listCards[i]\n        }));\n        cards.push(new _Card_mjs__WEBPACK_IMPORTED_MODULE_0__[\"default\"]({\n          suit: listSuits[1],\n          rating: rating,\n          name: listCards[i]\n        }));\n        cards.push(new _Card_mjs__WEBPACK_IMPORTED_MODULE_0__[\"default\"]({\n          suit: listSuits[2],\n          rating: rating,\n          name: listCards[i]\n        }));\n        cards.push(new _Card_mjs__WEBPACK_IMPORTED_MODULE_0__[\"default\"]({\n          suit: listSuits[3],\n          rating: rating,\n          name: listCards[i]\n        }));\n      }\n\n      return (0,_helpers_mjs__WEBPACK_IMPORTED_MODULE_2__.shuffle)(cards);\n    }\n  }, {\n    key: \"playersGenerate\",\n    value: function playersGenerate(players) {\n      return players.map(function (player) {\n        return new _Player_mjs__WEBPACK_IMPORTED_MODULE_1__[\"default\"]({\n          name: player,\n          id: players.indexOf(player)\n        });\n      });\n    }\n  }, {\n    key: \"firstDealCards\",\n    value: function firstDealCards() {\n      var _this = this;\n\n      this.players.forEach(function (player) {\n        return player.getCard([_this.cards.pop(), _this.cards.pop()]);\n      });\n    }\n  }, {\n    key: \"passPlayer\",\n    value: function passPlayer() {\n      this.canStep.splice(this.canStep.indexOf(this.activePlayer), 1);\n\n      if (this.canStep.length === 0) {\n        this.activePlayer = null;\n        return this.endGame();\n      }\n\n      if (this.canStep.indexOf(this.activePlayer) + 1) {\n        this.activePlayer = this.canStep[this.canStep.indexOf(this.activePlayer)];\n      } else {\n        this.activePlayer = this.canStep[0];\n      }\n\n      return \"now step \".concat(this.activePlayer.name);\n    }\n  }, {\n    key: \"endGame\",\n    value: function endGame() {\n      var winner = null;\n      var listHave21 = [];\n      (0,_helpers_mjs__WEBPACK_IMPORTED_MODULE_2__.findMaxRaitingPlayers)(this.players);\n      this.players.forEach(function (player) {\n        return player.rating === 21 ? listHave21.push(player.name) : player;\n      });\n      this.activeGame = false;\n\n      if (listHave21.length) {\n        winner = listHave21;\n        return \"\".concat(winner, \" is Winner\");\n      }\n\n      if ((0,_helpers_mjs__WEBPACK_IMPORTED_MODULE_2__.separatePlayers)(this.players).listRaitingUnder21.length) {\n        winner = (0,_helpers_mjs__WEBPACK_IMPORTED_MODULE_2__.separatePlayers)((0,_helpers_mjs__WEBPACK_IMPORTED_MODULE_2__.findMaxRaitingPlayers)(this.players)).listRaitingUnder21[0].name;\n        return \"\".concat(winner, \" is Winner\");\n      }\n\n      winner = (0,_helpers_mjs__WEBPACK_IMPORTED_MODULE_2__.separatePlayers)((0,_helpers_mjs__WEBPACK_IMPORTED_MODULE_2__.findMaxRaitingPlayers)(this.players)).listRaitingUpper21.reverse()[0].name;\n      return \"\".concat(winner, \" is Winner\");\n    }\n  }]);\n\n  return Game;\n}();\n\n\n\n//# sourceURL=webpack://blackdjack/./src/scripts/Game.mjs?");
